...
namespace UE4PropVis.Constants
{
	public static class Typ
	{
		...
		public const string AssetPtr = "FAssetPtr";
	...
	public static class Prop
	{
		...
		public const string Asset = "AssetObjectProperty";
		public const string AssetClass = "AssetClassProperty";
	...
	public static class CppProp
	{
		...
		public const string Asset = Pfx + Prop.Asset;
		public const string AssetClass = Pfx + Prop.AssetClass;
	...
	public static class Memb
	{
		...
		// UClassProperty/UAssetClassProperty
